...
public static class HarvestTableJobFactory
{
    public static Job Create(Vector2Int startPosition, WorldTile startTile, Vector2Int endPosition, WorldTile harvestTile)
    {
        ...
        JobStep visitTable = new JobStep(JobType.DropOff, startTile, startPosition, 2, false, 0);
        ...
        JobStep harvest = new JobStep(JobType.Harvest, tile, endPosition, tile.BuildTime, false, tile.Rotations);
