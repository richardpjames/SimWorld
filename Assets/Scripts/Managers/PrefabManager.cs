...
public class PrefabManager : MonoBehaviour
{
    ...
    public Terrain Grass { get => new Terrain(name: "Grass", tile: _grassTile, rotation: Quaternion.identity, movementCost: 1, width: 1, height: 1, buildCost: 0, layer: WorldLayer.Grass); }
    [SerializeField] private TileBase _sandTile;
    public Terrain Sand { get => new Terrain(name: "Sand", tile: _sandTile, rotation: Quaternion.identity, movementCost: 0.5f, width: 1, height: 1, buildCost: 0, layer: WorldLayer.Sand); }
    [SerializeField] private TileBase _waterTile;
    public Terrain Water { get => new Terrain(name: "Water", tile: _waterTile, rotation: Quaternion.identity, movementCost: 0, width: 1, height: 1, buildCost: 0, layer: WorldLayer.Water, buildingAllowed: false); }
    ...
    public Rock Rock { get => new Rock(name: "Rock", tile: _rockTile, rotation: Quaternion.identity, movementCost: 0.5f, width: 1, height: 1, buildCost: 1); }
    // Floors start here
    [Header("Floors")]
